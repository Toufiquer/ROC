  ...
  return (
    <nav
      className="
        ...
        bg-linear-to-r from-blue-950/60 via-sky-900/40 to-blue-950/60
            ...
            {menuData.map(item => (
              <Link
                ...
                className="
                  ...
                  after:bg-linear-to-r after:from-sky-400 after:to-blue-500 after:transition-all after:duration-300
                  hover:after:w-full
                "
              >
                {item.name}
