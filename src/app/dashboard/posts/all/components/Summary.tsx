    ...
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      <DialogTrigger asChild>
        <Button
          variant="outline"
          size="sm"
          className="bg-linear-to-r from-blue-500/20 to-purple-500/20 border-white/30 text-white 
                     hover:from-blue-500/30 hover:to-purple-500/30 hover:border-white/50 
      ...
      <DialogContent
        className="sm:max-w-6xl max-h-[90vh] mt-4 overflow-y-auto rounded-2xl border border-white/20 
      ...
      >
        <DialogHeader className="space-y-3 pb-4 border-b border-white/10">
          ...
          <DialogDescription className="text-white/60 text-base">Comprehensive overview of your users data with interactive visualizations</DialogDescription>
        </DialogHeader>
