...
export interface ICourseItem extends Document {
  _id: Types.ObjectId;
  name: string;
  path?: string;
  icon?: string;
...
// export model (collection name 'course')
export default (mongoose.models.Course as mongoose.Model<ICourseItem>) || mongoose.model<ICourseItem>('Course', courseSchema, 'course');
