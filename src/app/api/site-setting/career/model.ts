...
const careerSchema = new Schema<ICareerItem>(
  {
    name: { type: String, required: true },
    path: String,
    icon: String,
...
// export model (collection name 'career')
export default (mongoose.models.Career as mongoose.Model<ICareerItem>) || mongoose.model<ICareerItem>('Career', careerSchema, 'career');
