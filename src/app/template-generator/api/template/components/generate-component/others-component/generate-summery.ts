  ...
  return (
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      <DialogTrigger asChild>
        <Button variant="outline" size="sm" className="bg-linear-to-r from-blue-500/20 to-purple-500/20 border-white/30 text-white hover:from-blue-500/30 hover:to-purple-500/30 hover:border-white/50 transition-all duration-300">
